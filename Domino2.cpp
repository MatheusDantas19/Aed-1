	...
	//	if (cont>0) cout<<"\nAgora é a vez do Jogador "<<p<<" jogar:"<<endl;
		...
		if(p==1 && !jogou){
			...
			if(contador==0){
				...
				cout<<"Digite o numero lado a jogar: ";
				while(flagint!=0){
					cin>>lado;
		...
		if(p==2 && !jogou){
			...
			if(contador==0){
				contPassou++;
				cout<<"\nJogador "<<p<<"PASSOU!"<<endl;
				cout<<"**************************************"<<endl;
				valida=true;
				jogou=true;
				p=3;
				if(contPassou==3){
					pontoDupla1=pontoDupla1-20+50;
				}else if(contPassou==1){
				...
				cout<<"Digite o numero do lado a jogar: ";
				while(flagint!=0){
					//cout<<"Digite Novamente:"<<endl;
					cin>>lado;
					if(lado>=1 && lado<=4) break;
		...
		if(lado1.tam()==1 || lado2.tam()==1 || lado3.tam()==1 || lado4.tam()==1 || aux==0 ){
			for(int i=0;i<1;i++){
				if(lado1.tam()==1){
					jogada++;
				}
		...
		if(pAux==1 && multiplo==true){
			pontoDupla1+=aux3;
		}else if(pAux==2 && multiplo==true){
			pontoDupla2+=aux3;
		}else if(pAux==3 && multiplo==true){
			pontoDupla1+=aux3;
		}else if(pAux==4 && multiplo==true){
			pontoDupla2+=aux3;
		}
		cout<<endl;
		errou=false;
		...
		if(qtd1==7){
		 	if(pontoDupla1>pontoDupla2){
				cout<<"\nDupla 1 Ganhou!!!"<<endl;
				break;
			}else if(pontoDupla1<pontoDupla2){
				cout<<"\nDupla 2 Ganhou!!!"<<endl;
				break;
			}else if(pontoDupla1==pontoDupla2){
				cout<<"\nEmpate"<<endl;
